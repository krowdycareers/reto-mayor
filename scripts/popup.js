...
const myGetLocal = document.getElementById("btnGetLocalStorage");
...
//myButton.addEventListener('click', sendMessageToActiveTab); //antes
...
myGetLocal.addEventListener("click", () => {
  // Para obtenerlo
